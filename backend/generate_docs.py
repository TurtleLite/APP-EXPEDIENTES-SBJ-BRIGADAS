...
def manual_direccion(out_dir, version="1.0"):
    ...
    b.numbered("3. El Nº de expediente se asigna automáticamente. Si el paciente ya tiene un expediente (misma identidad), el sistema lo sugiere con un sufijo de copia (ej.: 23455 (1), 23455 (2)...) y muestra un mensaje de confirmación preguntando si será otra intervención del paciente; al confirmar, el expediente se guarda como copia del original.")
...
def manual_direccion_medica(out_dir, version="1.0"):
    ...
    b.numbered("1. Presione el botón <b>Nuevo</b>.")
    b.numbered("2. Complete el formulario: identidad, nombre, apellido, edad, sexo, domicilio, teléfono, diagnóstico, especialidad, perfil y criticidad clínica (Baja, Media o Alta), entre otros campos. El Nº de expediente se asigna automáticamente; si el paciente ya tiene un expediente (misma identidad), el sistema sugiere la copia (ej.: 23455 (1)) y pide confirmar que será una nueva intervención antes de guardar.")
...
def manual_medico(out_dir, version="1.0"):
    ...
    b.body("Crear un expediente")
    b.numbered("1. Presione el botón <b>Nuevo</b>.")
    b.numbered("2. Complete el formulario con los datos del paciente (identidad, nombre, apellido, edad, sexo, domicilio, teléfono, diagnóstico, especialidad, perfil y criticidad clínica, entre otros). El Nº de expediente se asigna automáticamente; si el paciente ya tiene un expediente (misma identidad), el sistema sugiere la copia (ej.: 23455 (1)) y pregunta confirmar que será una nueva intervención antes de guardar.")
