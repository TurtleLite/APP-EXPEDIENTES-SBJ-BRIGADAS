  ...
  return (
    <div className="fixed inset-0 bg-slate-900/20 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white/95 rounded-xl w-[95vw] max-w-5xl max-h-[90vh] flex flex-col overflow-hidden">
        <div className="px-5 py-3 border-b border-[#e8e3da] flex items-center justify-between shrink-0">
          <div>
        ...
        <div className="flex-1 overflow-y-auto min-h-0 h-0 px-5 pb-3 space-y-2">
          {sections.map((section) => {
            ...
            return (
              <div key={section.title} className="border border-[#e8e3da] rounded-xl overflow-hidden">
                <button
                  type="button"
                        ...
                        {field.key === 'especialidad' ? (
                          <div className="relative">
                            <input
                              ...
                              className="w-full px-3 py-2 border border-[#e8e3da] rounded-lg text-sm focus:ring-2 focus:ring-slate-300 focus:border-slate-400"
                            />
                          ...
                          return (
                            <div className="flex gap-2">
                              <input
                                ...
                                className="flex-1 px-3 py-2 border border-[#e8e3da] rounded-lg text-sm focus:ring-2 focus:ring-slate-300 focus:border-slate-400"
                              />
                              <select
                                value={edadUnit}
                                onChange={(e) => {
                                ...
                                className="w-28 px-3 py-2 border border-[#e8e3da] rounded-lg text-sm focus:ring-2 focus:ring-slate-300 focus:border-slate-400"
                              >
                          ...
                          <div className="relative">
                            <input
                              ...
                              placeholder="0 kg"
                              className="w-full px-3 py-2 pr-10 border border-[#e8e3da] rounded-lg text-sm focus:ring-2 focus:ring-slate-300 focus:border-slate-400"
                            />
                          ...
                          <textarea
                            ...
                            className="w-full px-3 py-2 border border-[#e8e3da] rounded-lg text-sm focus:ring-2 focus:ring-slate-300 focus:border-slate-400 resize-none"
                          />
                        ) : field.key === 'domicilio' ? (
                          <textarea
                            rows={3}
        ...
        <div className="px-5 py-3 border-t border-[#e8e3da] flex items-center justify-between shrink-0">
          <button
            onClick={onClose}
