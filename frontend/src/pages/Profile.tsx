  ...
  return (
    <div className="h-full flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 flex-1 min-h-0 lg:grid-rows-[minmax(0,1fr)] overflow-y-auto">
        <section className="bg-white rounded-2xl shadow-sm border border-[#E3E6EB] p-5 lg:overflow-y-auto lg:min-h-0">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 px-3 py-2.5 border border-slate-100 bg-slate-100 rounded-xl text-sm text-slate-500">
                <UserIcon size={14} />
                {user.username}
              </div>            </div>
            <div>
