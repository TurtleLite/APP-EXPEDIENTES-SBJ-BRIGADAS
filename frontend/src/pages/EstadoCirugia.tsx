        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="relative">
            <select
              ...
              className="px-3 py-2 pr-8 border border-[#f0e0c0] rounded-xl text-sm bg-white focus:ring-2 focus:ring-slate-300/30 focus:border-slate-400 transition-all duration-200 appearance-none"
            >
                  ...
                  <td className="px-6 py-4">
                    {editingId === r.id ? (
                      <select
                        ...
                        className="px-2 py-1.5 border border-[#f0e0c0] rounded-xl text-sm bg-white focus:ring-2 focus:ring-slate-300/30 focus:border-slate-400 transition-all duration-200"
                      >
