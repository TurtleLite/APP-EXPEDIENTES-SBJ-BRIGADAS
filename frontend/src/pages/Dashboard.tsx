      ...
      <header className="shrink-0">
        <div className="flex items-center justify-between gap-4">
          <div className="min-w-0">
            <p className="text-[#8A82BC] text-xs font-semibold uppercase tracking-[0.2em] truncate">
        ...
        <div className="w-full flex flex-wrap gap-3">
          {options.map((opt) => (
            <button
              ...
              className="flex-1 min-w-[160px] h-40 flex flex-col items-center justify-center gap-2.5 rounded-2xl bg-white border border-slate-100 hover:border-[#E6E2F2] hover:shadow-md transition-all duration-200 group"
            >
