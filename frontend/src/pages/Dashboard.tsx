  ...
  return (
    <div className="flex flex-col gap-4 h-full min-h-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-1 min-h-0">
        <section className="lg:col-span-3 bg-white rounded-2xl shadow-sm border border-[#a9ded6] p-5 flex flex-col min-h-0">
          <div className="flex items-center justify-between mb-4 shrink-0">
            <h2 className="font-serif text-sm font-semibold text-[#134e4a]">Acciones rápidas</h2>
            ...
            <div className="space-y-2 overflow-y-auto min-h-0">
              {recentLists.map((list) => (
                <button
                  ...
                  className="w-full flex items-center gap-3.5 px-3.5 py-2.5 rounded-xl border border-slate-100 hover:border-[#a9ded6] hover:bg-slate-50/70 text-left transition-all duration-200 group"
                >
                  ...
                  <span className="text-[10px] font-medium text-slate-400 bg-teal-50 border border-slate-100 rounded-lg px-2 py-1 shrink-0">
        ...
        {showReports && (
          <section className="lg:col-span-4 bg-white rounded-2xl shadow-sm border border-[#a9ded6] p-5 flex flex-col min-h-0">
            <div className="flex items-center justify-between mb-4 shrink-0">
...
function StatCard({ icon, label, value, iconBg, cardBg, onClick }: {
  ...
  return (
    <button
      onClick={onClick}
      className={`group relative overflow-hidden rounded-2xl border border-[#a9ded6] ${cardBg} p-4 text-left shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200`}
    >
